        ...
        <KeyboardAvoidingView behavior="padding" enabled={true}>
          <Form style={styles.frmlogin}>
            <Item style={[styles.frmlogin__item, styles.bgf, {paddingLeft: 16,}]} rounded>
              <Input value={this.state.username} placeholder="Tài khoản" onChangeText={(username) => this.setState({username})} style={styles.frmlogin__input}/>
            </Item>
            <Item style={[styles.frmlogin__item, styles.bgf ,{paddingLeft: 16,}]} rounded>
              <Input value={this.state.password} placeholder="Mật khẩu" onChangeText={(password) => this.setState({password})} secureTextEntry={true} style={styles.frmlogin__input}/>
            </Item>
